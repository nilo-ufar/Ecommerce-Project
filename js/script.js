...
var countDownDate = new Date("June 16, 2019 15:40:50").getTime();
...
var x = setInterval(function () {
    ...
    for (var i = 0; i < z.length; i++) {
        z[i].innerHTML = '<span id="day">' + days + "</span>" + '<span id="hours">' + hours + "</span>" + '<span id="minutes">' + minutes + "</span>" + '<span id="seconds">' + seconds + "</span>";
    }
